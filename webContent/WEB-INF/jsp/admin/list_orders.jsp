					...
					<input type="hidden" name="command" value="changeStatus" />
						...
						<thead>
							<tr>
								...
								<td><fmt:message key="list_orders_jsp.table.user_login" /></td>
								<td><fmt:message key="list_orders_jsp.table.user_name" /></td>
								<td><fmt:message key="list_orders_jsp.table.count" /></td>
								<td><fmt:message key="list_orders_jsp.table.date" /></td>
								<td><fmt:message key="list_orders_jsp.table.amount" /></td>
								<td><fmt:message key="list_orders_jsp.table.status" /></td>
								<td><fmt:message key="list_orders_jsp.table.change_status" /></td>
								<td><input type="submit" class="btn btn-sm btn-warning"
										   value="<fmt:message key="list_orders_jsp.button.change_status" />"></td>
							</tr>
						</thead>
						...
						<c:forEach var="bean" items="${userOrderBeanList}">
							<tr>
								...
								<td>${bean.userLogin}</td>
								<td>${bean.userName}</td>
								<td>${bean.countOfOrders}</td>
								<td>${bean.date}</td>
								<td>${bean.amount}</td>
								<td>${bean.statusName}</td>
								<td><select name="statusName" class="form-control input-sm">
									<option value="${item.statusName}">
											${item.statusName}
									</option>
									<option value="paid">
										<fmt:message key="list_orders_jsp.table.paid" />
									</option>
									<option value="canceled">
										<fmt:message key="list_orders_jsp.table.canceled" />
									</option>
								</select></td>
							</tr>
							</tr>

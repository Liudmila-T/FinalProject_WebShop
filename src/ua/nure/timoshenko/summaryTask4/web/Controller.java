package ua.nure.timoshenko.summaryTask4.web;

import org.apache.log4j.Logger;
import ua.nure.timoshenko.summaryTask4.web.command.Command;
import ua.nure.timoshenko.summaryTask4.web.command.ContainerCommand;
...
public class Controller extends HttpServlet {
	...
	private void process(HttpServletRequest request,
		...
		Command command = ContainerCommand.get(commandName);
